    ...
    <div class="wrapper">
        ...
        <form name="form1" action="" method="POST">
            <div class="imgcontainer">
                <img src="assets/img/canteenwala.png" alt="Avatar" class="avatar">
            </div>
            ...
            <br>
            <div class="pass-txt"><a href="forgot_password.php">Forgot password?</a></div>
            <input type="submit" name="submit" value="Login">
            <div class="sg-text">or go back to
                <label class="sg-text=label">
                    <span id="gf0vvq" aria-hidden="true"><a href="home.php">Home page</a></span>
                </label>
            </div>
