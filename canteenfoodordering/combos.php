...
<head>
    <link rel="stylesheet" href="assets/css/combos.css">
...
<body>
    ...
    <div class="combo-menu">
        ...
        if (isset($_POST['increment'])) {
            $id = $_POST['increment'];
            $result = mysqli_query($conn, "Select `name` from `combo` where combo_id='" . $id . "';");
                        ...
                        <div class="cost">
                            ...
                            if (!empty($_SESSION['cart'])) {
                                foreach ($_SESSION['cart'] as $item => $itemQuantity) {
                                    $rest = mysqli_query($conn, "SELECT * from `combo` where `name`='" . $item . "';");
                                    if ($rest->num_rows == 1) {
                                        $n = $rest->fetch_assoc();
                                        $_POST['quantity' . $n['combo_id']] = $itemQuantity;
                                    }
                                }
                            }
