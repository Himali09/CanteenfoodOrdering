    ...
    <div class="orderlist">
        <div class="yourlist">
            ...
            if (isset($_POST['search'])) {
                $sdate = date($_POST['start']);
                $edate = date($_POST['end']);
                $sql = "SELECT * from order_today where `time` between '".$sdate."' and '".$edate."' and( `status`='2' or `status`='3' )order by `time` desc;";
            ...
            ?>
                    <div class="past-order">
                        <div class="Order-hist">
                            ...
                            <img src='./assets/img/<?php echo $path; ?>' alt="">
                            <div class="odetails">
                            <?php
                            if (!empty($food)) {
