...
$select1 = $select2 = '';
$choose1 = $choose2 = $choose3 = $choose4 = $choose5 = $choose6 = $choose7 = $choose8 = '';
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select name="department" id="department">
                            <option value="select">Select</option>
                            <option value="FE" <?php echo $choose1; ?>>FE</option>
                            <option value="Computer" <?php echo $choose2; ?>>COMPS</option>
                            <option value="Information Technology" <?php echo $choose3; ?>>IT</option>
                            <option value="EXTC" <?php echo $choose4; ?>>EXTC</option>
                            <option value="Civil" <?php echo $choose5; ?>>CIVIL</option>
                            <option value="CSE AI-ML" <?php echo $choose6; ?>>CSE AI-ML</option>
                            <option value="CSE DS" <?php echo $choose7; ?>>CSE DS</option>
                            <option value="Mechaical" <?php echo $choose8; ?>>MECH</option>
                        </select>
                    </div>
                </div>
            </div>
