...
<head>
    <link rel="stylesheet" href="assets/css/admin_menu_view.css">
...
<body>
    ...
    <nav class="navbar navbar-expand-sm navbar-custom1">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link" href="http://localhost/canteenfoodordering/admin_menu_add.php?key=0"><i class="fa fa-plus" aria-hidden="true"></i> Add</a>
            </li>
        </ul>
    </nav>
    ...
    <div class="menu">
        ...
        if (isset($_POST['quantity'])) {
            $id = $_POST['quantity'];
header('Location: http://localhost/canteenfoodordering/admin_menu_add.php?key='.$id.'');
        }
        if (isset($_POST['qbtn'])) {
            $id = $_POST['qbtn'];
        ...
        ?>
                ...
                <div class="single-menu">
                    ...
                    <div class="menu-content">
                        ...
                        <div class="cost">
                            ...
                            <input type='text' disabled value=<?php echo $row['quantity'];?> name='quantity'>
                            <?php
                            if ($row["visible"] == 0) {
                                $button_display = "Add to Menu";
                            } else {
            ...
            <button class="qbtn" name='quantity' value='<?php echo $name; ?>'>Edit</button>
    </div>
<?php
        };
?>
